...
public class CertificateAuthority {
    ...
    /// Initialize an instance of `CertificateAuthority` with specified X509 CA certificate and privateKey.
    /// - Parameters:
    ...
    /// Initialize an instance of `CertificateAuthority` with specified passphrase and base64 encoded PKCS12 string.
    ///
    ...
    /// Initialize an instance of `CertificateAuthority` with specified passphrase and PKCS12.
    ///
    ...
    /// Initialize an instance of `CertificateAuthority` with specified organization and commonName.
    ///
    ...
    public convenience init(organization: String, commonName: String) {
        ...
        CertificateAuthority.boringSSLX509AddExtension(
            x509: certificate,
    ...
    static func exportP12Bundle(
        ...
        let ca = CertificateAuthority(certificate: certificate, privateKey: privateKey)
        let buffer = try CertificateAuthority.convertP12ToDERBytes(
            ca.exportP12Bundle(passphrase: passphrase, name: name)
        )
    ...
    public func exportBase64EncodedP12String(passphrase: String? = nil) throws -> String {
        ...
        return Data(try CertificateAuthority.convertP12ToDERBytes(p12)).base64EncodedString()
    }
