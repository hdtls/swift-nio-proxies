...
extension ByteBuffer {
    ...
    mutating func readUsernamePasswordAuthenticationIfPossible() throws
    ...
    @discardableResult mutating func writeUsernamePasswordAuthentication(
        _ authentication: UsernamePasswordAuthentication
    ) -> Int {
        var written = 0
    ...
    mutating func readUsernamePasswordAuthenticationResponse() throws
    ...
    @discardableResult mutating func writeClientBasicAuthenticationResponse(
        _ response: UsernamePasswordAuthenticationResponse
    ) -> Int {
        var written = 0
