...
/// in the SOCKS5 dialog. For server connections, use the `SOCKS5ProxyServerHandler`.
public final class SOCKS5ProxyClientHandler: SOCKS5ProxyHandler {
...
extension SOCKS5ProxyClientHandler: RFC1919 {
