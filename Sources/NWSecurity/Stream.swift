...
final class SodiumStream: Cryptor, Updatable {
    ...
    init(algorithm: Algorithm, key: [UInt8], mode: Mode) throws {
        ...
        switch algorithm {
        case .salsa20:
            cipher = crypto_stream_salsa20_xor_ic
        case .chacha20:
            cipher = crypto_stream_chacha20_xor_ic
        case .chacha20ietf:
            cipher = { (c, m, mlen, n, ic, k) in
                crypto_stream_chacha20_ietf_xor_ic(c, m, mlen, n, UInt32(ic), k)
            }
            break
        case .xchacha20:
            cipher = crypto_stream_xchacha20_xor_ic
        default:
