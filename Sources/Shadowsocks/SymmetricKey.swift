...
/// - Returns: hash result
@inline(__always)
fileprivate func __bytesToKey(_ secretKey: String, saltByteCount: Int, outputByteCount: Int) -> [UInt8] {
    var i = 0
...
///
func hkdfDerivedSymmetricKey<Salt: DataProtocol>(secretKey: String, salt: Salt, outputByteCount: Int) -> SymmetricKey {
    let inputKeyMaterial = SymmetricKey(data: __bytesToKey(secretKey, saltByteCount: salt.count, outputByteCount: outputByteCount))
