...
let paddingMaskingAES128GCMResponse: [ByteBuffer] = [
  ByteBuffer(
    bytes: try! Data(
      hexString: "f9b53af2a0b7d87ca97fb9f089ba97ed114815ab943557c441cfc86700c4ddd21db3c6c49e7d"
    )
  ),
...
final class VMESSDecoderTests: XCTestCase {
  ...
  let symmetricKey = SymmetricKey(data: try! Data(hexString: "45d4c42bbefab09de35e498fca4ff920"))
  let nonce = try! Nonce(data: Data(hexString: "9ebdbde706ba8d3e6e96241dc6344afa"))
  ...
  func testBasicVerifications() throws {
    ...
    expected = .body(ByteBuffer(bytes: try Array(hexString: ResponseTestsData.expectedFirstFrame)))
    ...
    expected = .body(ByteBuffer(bytes: try Array(hexString: ResponseTestsData.expectedSecondFrame)))
    ...
    expected = .body(ByteBuffer(bytes: try Array(hexString: ResponseTestsData.expectedThirdFrame)))
  ...
  func testUsingInsufficientDataToParseResponseHeadersThatDoNotContainCommands() throws {
    ...
    var data = ByteBuffer(
      bytes: try Array(
        hexString: "f9b53af2a0b7d87ca97fb9f089ba97ed11"
      )
    )
    ...
    data = ByteBuffer(bytes: try Array(hexString: "4815ab943557c441cfc86700c4ddd21db3c6c49e"))
    XCTAssertNoThrow(try channel.writeInbound(data))
  ...
  func testParsingResponseHeaderWithDataContainingIncorrectlyEncryptedHeaderDataLength() {
    ...
    let data = ByteBuffer(
      bytes: try! Array(
        hexString: "f9b53af2a0b7d87ca97fb9f089ba97ed1149"
      )
    )
  ...
  func testParsingResponseFrameWithInsufficientDataAndPaddingMaskingStreamOptions() throws {
    ...
    let expected = VMESSPart<VMESSResponseHead, ByteBuffer>.body(
      ByteBuffer(bytes: try Array(hexString: ResponseTestsData.expectedFirstFrame))
    )
    XCTAssertEqual(
      try channel.readInbound(as: VMESSPart<VMESSResponseHead, ByteBuffer>.self),
      expected
