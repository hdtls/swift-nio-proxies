...
final class ProfileSerializationTests: XCTestCase {
    ...
    func testSerializePolicies() throws {
        ...
        let policiesString = """
            ...
            SHADOWSOCKS = ss, server-address=127.0.0.1, port=8330, algorithm=chacha20-poly1305, password=password, tfo=true
            VMESS = vmess, server-address=127.0.0.1, port=8390, username=2EB5690D-225B-4B49-997F-697D5A36CD9D
            """
    ...
    func testSerializePolicyGroups() throws {
        let expectedPolicyGroupsJsonString =
            "{\"policies\":[{\"name\":\"HTTP\",\"proxy\":{\"port\":8310,\"protocol\":\"http\",\"serverAddress\":\"127.0.0.1\"},\"type\":\"http\"}],\"policyGroups\":[{\"name\":\"PROXY\",\"policies\":[\"HTTP\"]},{\"name\":\"BLOCK\",\"policies\":[\"DIRECT\",\"REJECT\",\"REJECT-TINYGIF\"]}]}"
    ...
    func testSerializeRules() throws {
        let expectedRulesJsonString =
            "{\"policies\":[{\"name\":\"HTTP\",\"proxy\":{\"port\":8310,\"protocol\":\"http\",\"serverAddress\":\"127.0.0.1\"},\"type\":\"http\"}],\"policyGroups\":[{\"name\":\"PROXY\",\"policies\":[\"HTTP\"]},{\"name\":\"BLOCK\",\"policies\":[\"DIRECT\",\"REJECT\",\"REJECT-TINYGIF\"]}],\"rules\":[\"DOMAIN-SUFFIX,example.com,DIRECT\",\"RULE-SET,SYSTEM,DIRECT\",\"GEOIP,CN,DIRECT\",\"FINAL,PROXY\"]}"
