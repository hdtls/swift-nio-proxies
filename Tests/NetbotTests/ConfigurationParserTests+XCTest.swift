...
extension ConfigFileParsingTests {

   static var allTests : [(String, (ConfigFileParsingTests) -> () throws -> Void)] {
      return [
                ("testParsingRuleWithoutComment", testParsingRuleWithoutComment),
                ("testParsingRuleWithComment", testParsingRuleWithComment),
